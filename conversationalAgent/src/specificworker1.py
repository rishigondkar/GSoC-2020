...
class SpecificWorker(GenericWorker):
    ...
    def AGMinit(self):
        ...
        src = self.worldModel
        print(src.nodes)
        #person_attributes = src.getNode("3274")
    ...
    def writeToFile(self,id,situation):
        #self.AGMinit()
        #try:
        """person_attributes = src.getNode(str(id)).attributes
        attributes = {}
        ...
        with open("/home/rishi/robocomp/components/robocomp-viriato/components/conversationalAgent/chatbot/person_attributes.json", "w") as outfile: 
    ...
    def compute(self):
        ...
        self.keepUiActive()
        #self.updateGraph()
        #print(self.interaction.isVisible())
        # computeCODE
        # try:
    ...
    def AGMCommonBehavior_activateAgent(self, prs):
        ...
        if prs['action'].value != 'none':
            ...
            if self.interaction.interactionUI == False:
                ...
                elif prs['action'].value == 'path_softBlock':
                    if self.interaction.isVisible() == False:
                        self.interaction.interactionUI = True
                        self.situation = 'two'
                        self.link = "softBlock"
